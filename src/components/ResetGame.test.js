...
describe("renders", () => {
  ...
  describe("resetting state is false", () => {
    ...
    it("does not render the user input", () => {
      const input = findByTestAttr(wrapper, "secret-word-input");
  ...
  describe("resetting state is true", () => {
    ...
    describe("error state is false", () => {
      it("does not render the error message", () => {
        wrapper = setup();
        wrapper.setState({ resetting: true, errorMessage: false });
        const errorMessage = findByTestAttr(wrapper, "error-message");
